    ...
    operations = [
            ...
            fields=[
                ...
                ('kind',
                 models.CharField(blank=True,
                                  choices=[('ITA', 'ITA (Intent to adopt)'),
                ...
                ('event',
                 models.CharField(choices=[('MOD', 'modified'), ('OPEN', 'opened'),
                                           ('CLOSE', 'closed')],
                                  max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind',
                 models.CharField(choices=[('ITA', 'ITA (Intent to adopt)'),
                                           ('ITP', 'ITP (Intent to package)'),
                                           ('O', 'O (Orphaned)'),
                                           ('RFA', 'RFA (Request for adoption)'),
                                           ('RFH', 'RFH (Request for help)'),
                ...
                ('popcon',
                 models.ForeignKey(db_column='project',
                                   null=True,
